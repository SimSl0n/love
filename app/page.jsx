...
export default function Home() {
    ...
    // 1. Инициализация WebRTC с TURN-серверами Metered
    useEffect(() => {
        if (!role) return;
    ...
    // 3. Взрыв сердечек (35 штук, крупные, летят дальше)
    useEffect(() => {
